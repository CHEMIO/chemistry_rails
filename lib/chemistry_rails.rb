...
module ChemistryRails
  ...
  ELEMENTS = [
      ...
      { short: 'P',  long: 'Phosphorus',   mass: 30.973762, category: 5,
        radionuclides: [
            { name: 'P-32', exemption_level: 10**5, t_medium: 14.3, d_value: 1 * (10**1) * (10**12) },
      ...
      { short: 'Fe', long: 'Iron',         mass: 54.847,    category: 2,
        radionuclides: [
            ...
            { name: 'Fe-55', exemption_level: 10**6, t_medium: 365 * (2.70), d_value: 8 * (10**2) * (10**12) },
      ...
      { short: 'Co', long: 'Cobalt',       mass: 58.9332,   category: 2,
        radionuclides: [
            ...
            { name: 'Co-57', exemption_level: 10**6, t_medium: 271, d_value: 7 * (10**-1) * (10**12) },
            ...
            { name: 'Co-60', exemption_level: 10**5, t_medium: 365 * (5.27), d_value: 3 * (10**-2) * (10**12) },
      ...
      { short: 'Ni', long: 'Nickel',       mass: 58.6934,   category: 2,
        radionuclides: [
            ...
            { name: 'Ni-63', exemption_level: 10**8, t_medium: 365 * (96), d_value: 6 * (10**1) * (10**12) },
      ...
      { short: 'Ge', long: 'Germanium',    mass: 72.64,     category: 4,
        radionuclides: [
            ...
            { name: 'Ge-68', exemption_level: 10**5, t_medium: 288 , d_value: 7 * (10**-2) * (10**12)},
      ...
      { short: 'Se', long: 'Selenium',     mass: 78.96,     category: 5,
        radionuclides: [
            ...
            { name: 'Se-75', exemption_level: 10**6, t_medium: 120 , d_value: 2 * (10**-1) * (10**12)},
      ...
      { short: 'Kr', long: 'Krypton',      mass: 83.80,     category: 7,
        radionuclides: [
            ...
            { name: 'Kr-85', exemption_level: 10**4, t_medium: 10.73 * 365 , d_value: 3 * (10**1) * (10**12)},
      ...
      { short: 'Sr', long: 'Strontium',    mass: 87.62,     category: 1,
        radionuclides: [
            ...
            { name: 'Sr-90', exemption_level: 10**4, t_medium: 365 * (29.1) , d_value: 1 * (10**0) * (10**12)},
      ...
      { short: 'Mo', long: 'Molybdenum',   mass: 95.94,     category: 2,
        radionuclides: [
            ...
            { name: 'Mo-99', exemption_level: 10**6, t_medium: 2.75 , d_value: 3 * (10**-1) * (10**12)},
      ...
      { short: 'Tc', long: 'Technetium',   mass: 98.9072,   category: 2,
        radionuclides: [
            ...
            { name: 'Tc-99', exemption_level: 10**7, t_medium: 365 * (2.13*(10**5)) , d_value: 7 * (10**-1) * (10**12)},
      ...
      { short: 'Ru', long: 'Ruthenium',    mass: 101.07,    category: 2,
        radionuclides: [
            ...
            { name: 'Ru-106', exemption_level: 10**5, t_medium: 365 * (1.01) , d_value: 3 * (10**-1) * (10**12)},
        ]
      },
      ...
      { short: 'Pd', long: 'Palladium',    mass: 106.42,    category: 2,
        radionuclides: [
            ...
            { name: 'Pd-103', exemption_level: 10**8, t_medium: 17 , d_value: 9 * (10**1) * (10**12)},
      ...
      { short: 'Cd', long: 'Cadmium',      mass: 112.411,   category: 2,
        radionuclides: [
            ...
            { name: 'Cd-109', exemption_level: 10**6, t_medium: 365 * (1.27) , d_value: 2 * (10**1) * (10**12)},
      ...
      { short: 'I',  long: 'Iodine',       mass: 126.90447, category: 6,
        radionuclides: [
            ...
            { name: 'I-125', exemption_level: 10**6, t_medium: 60.1 , d_value: 2 * (10**-1) * (10**12)},
            ...
            { name: 'I-131', exemption_level: 10**6, t_medium: 8.04 , d_value: 2 * (10**-1) * (10**12)},
      ...
      { short: 'Cs', long: 'Cesium',       mass: 132.90543, category: 0,
        radionuclides: [
            ...
            { name: 'Cs-137', exemption_level: 10**4, t_medium: 365 * (30) , d_value: 1 * (10**-1) * (10**12)},
      ...
      { short: 'Pm', long: 'Promethium',   mass: 144.9127,  category:  8,
        radionuclides: [
            ...
            { name: 'Pm-147', exemption_level: 10**7, t_medium: 365 * (2.62) , d_value: 4 * (10**1) * (10**12)},
      ...
      { short: 'Gd', long: 'Gadolinium',   mass: 157.25,    category:  8,
        radionuclides: [
            ...
            { name: 'Gd-153', exemption_level: 10**7, t_medium: 242 , d_value: 1 * (10**0) * (10**12)},
      ...
      { short: 'Tm', long: 'Thulium',      mass: 168.93421, category:  8,
        radionuclides: [
            ...
            { name: 'Tm-170', exemption_level: 10**6, t_medium: 129 , d_value: 2 * (10**1) * (10**12)},
      ...
      { short: 'Yb', long: 'Ytterbium',    mass: 173.04,    category:  8,
        radionuclides: [
            ...
            { name: 'Yb-169', exemption_level: 10**7, t_medium: 32 , d_value: 3 * (10**-1) * (10**12)},
      ...
      { short: 'Ir', long: 'Iridium',      mass: 192.22,    category:  2,
        radionuclides: [
            ...
            { name: 'Ir-192', exemption_level: 10**4, t_medium: 74.0 , d_value: 8 * (10**-2) * (10**12)},
      ...
      { short: 'Au', long: 'Gold',         mass: 196.9665,  category:  2,
        radionuclides: [
            ...
            { name: 'Au-198', exemption_level: 10**6, t_medium: 2.69 , d_value: 2 * (10**-1) * (10**12)},
      ...
      { short: 'Tl', long: 'Thallium',     mass: 204.3833,  category:  3,
        radionuclides: [
            ...
            { name: 'Tl-204', exemption_level: 10**4, t_medium: 365 * (3.78) , d_value: 2 * (10**1) * (10**12)},
        ]
      },
      ...
      { short: 'Po', long: 'Polonium',     mass: 208.9824,  category:  4,
        radionuclides: [
            ...
            { name: 'Po-210', exemption_level: 10**4, t_medium: 138.0 , d_value: 6 * (10**-2) * (10**12)},
        ]
      },
      ...
      { short: 'Ra', long: 'Radium',       mass: 226.0254,  category:  1,
        radionuclides: [
            ...
            { name: 'Ra-226', exemption_level: 10**4, t_medium: 365 * (1.60*(10**3)) , d_value: 4 * (10**-2) * (10**12)},
      ...
      { short: 'Pu', long: 'Plutonium',    mass: 244.0642,  category:  9,
        radionuclides: [
            ...
            { name: 'Pu-238', exemption_level: 10**4, t_medium: 365 * (87.7) , d_value: 6 * (10**-2) * (10**12)},
            { name: 'Pu-239', exemption_level: 10**4, t_medium: 365 * (2.41*(10**4)) , d_value: 6 * (10**-2) * (10**12)},
      ...
      { short: 'Am', long: 'Americium',    mass: 243.0614,  category:  9,
        radionuclides: [
            ...
            { name: 'Am-241', exemption_level: 10**4, t_medium: 365 * (4.32*(10**2)) , d_value: 6 * (10**-2) * (10**12)},
      ...
      { short: 'Cm', long: 'Curium',       mass: 247.0703,  category:  9,
        radionuclides: [
            ...
            { name: 'Cm-244', exemption_level: 10**4, t_medium: 365 * (18.1) , d_value: 5 * (10**-2) * (10**12)},
      ...
      { short: 'Cf', long: 'Californium',  mass: 251.0796,  category:  9,
        radionuclides: [
            ...
            { name: 'Cf-252', exemption_level: 10**4, t_medium: 365 * (2.64) , d_value: 2 * (10**-2) * (10**12)},
