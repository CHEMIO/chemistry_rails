...
module ChemistryRails
  ...
  ELEMENTS = [
      ...
      { short: 'Yb', long: 'Ytterbium',    mass: 173.04,    category:  8,
        radionuclides: [
            { name: 'Yb-162', exemption_level: 10**7, t_medium: hours(0.315) },
            { name: 'Yb-166', exemption_level: 10**7, t_medium: 2.36 },
            { name: 'Yb-167', exemption_level: 10**6, t_medium: hours(0.292) },
            { name: 'Yb-169', exemption_level: 10**7, t_medium: 32 },
            { name: 'Yb-175', exemption_level: 10**7, t_medium: 4.19 },
            { name: 'Yb-177', exemption_level: 10**6, t_medium: hours(1.90) },
            { name: 'Yb-178', exemption_level: 10**6, t_medium: hours(1.23) },
        ]
      },   # 70
      { short: 'Lu', long: 'Lutetium',     mass: 174.967,   category:  8,
        radionuclides: [
            ...
            { name: 'Lu-173', exemption_level: 10**7, t_medium: years(1.37) },
            { name: 'Lu-174', exemption_level: 10**7, t_medium: years(3.31) },
            { name: 'Lu-174m', exemption_level: 10**7, t_medium: 142.0 },
            { name: 'Lu-176', exemption_level: 10**6, t_medium: years(3.60*(10**10)) },
            { name: 'Lu-176m', exemption_level: 10**6, t_medium: hours(3.68) },
            { name: 'Lu-177', exemption_level: 10**7, t_medium: 6.71 },
            { name: 'Lu-177m', exemption_level: 10**6, t_medium: 161.0 },
            { name: 'Lu-178', exemption_level: 10**5, t_medium: hours(0.473) },
            { name: 'Lu-178m', exemption_level: 10**5, t_medium: hours(0.378) },
            { name: 'Lu-179', exemption_level: 10**6, t_medium: hours(4.59) },
        ]
      },

      { short: 'Hf', long: 'Hafnium',      mass: 178.49,    category:  2,
        radionuclides: [
            { name: 'Hf-170', exemption_level: 10**6, t_medium: hours(16.0) },
            { name: 'Hf-172', exemption_level: 10**6, t_medium: years(1.87) },
            { name: 'Hf-173', exemption_level: 10**6, t_medium: hours(24.0) },
            { name: 'Hf-175', exemption_level: 10**6, t_medium: 70.0 },
            { name: 'Hf-177m', exemption_level: 10**5, t_medium: hours(0.856) },
            { name: 'Hf-178m', exemption_level: 10**6, t_medium: years(31.0) },
            { name: 'Hf-179m', exemption_level: 10**6, t_medium: 25.1 },
            { name: 'Hf-180m', exemption_level: 10**6, t_medium: hours(5.50) },
            { name: 'Hf-181', exemption_level: 10**6, t_medium: 42.4 },
            { name: 'Hf-182', exemption_level: 10**6, t_medium: years(9.0*(10**6)) },
            { name: 'Hf-182m', exemption_level: 10**6, t_medium: hours(1.02) },
            { name: 'Hf-183', exemption_level: 10**6, t_medium: hours(1.07) },
            { name: 'Hf-184', exemption_level: 10**6, t_medium: hours(4.12) },
        ]
      },
      { short: 'Ta', long: 'Tantalum',     mass: 180.9479,  category:  2,
        radionuclides: [
            { name: 'Ta-172', exemption_level: 10**6, t_medium: hours(0.613) },
            { name: 'Ta-173', exemption_level: 10**6, t_medium: hours(3.65) },
            { name: 'Ta-174', exemption_level: 10**6, t_medium: hours(1.20) },
            { name: 'Ta-175', exemption_level: 10**6, t_medium: hours(10.5) },
            { name: 'Ta-176', exemption_level: 10**6, t_medium: hours(8.08) },
            { name: 'Ta-177', exemption_level: 10**7, t_medium: 2.36 },
            { name: 'Ta-178', exemption_level: 10**6, t_medium: hours(2.20) },
            { name: 'Ta-179', exemption_level: 10**7, t_medium: years(1.82) },
            { name: 'Ta-180', exemption_level: 10**6, t_medium: years(10**13) },
            { name: 'Ta-180m', exemption_level: 10**7, t_medium: hours(8.10) },
            { name: 'Ta-182', exemption_level: 10**4, t_medium: 115.0 },
            { name: 'Ta-182m', exemption_level: 10**6, t_medium: hours(0.264) },
            { name: 'Ta-183', exemption_level: 10**6, t_medium: 5.10 },
            { name: 'Ta-184', exemption_level: 10**6, t_medium: hours(8.70) },
            { name: 'Ta-185', exemption_level: 10**5, t_medium: hours(0.816) },
            { name: 'Ta-186', exemption_level: 10**5, t_medium: hours(0.175) },
        ]
      },
      { short: 'W',  long: 'Tungsten',     mass: 183.85,    category:  2,
        radionuclides: [
            { name: 'W-176', exemption_level: 10**6, t_medium: hours(2.30) },
            { name: 'W-177', exemption_level: 10**6, t_medium: hours(2.25) },
            { name: 'W-178', exemption_level: 10**6, t_medium: 21.7 },
            { name: 'W-179', exemption_level: 10**7, t_medium: hours(0.625) },
            { name: 'W-181', exemption_level: 10**7, t_medium: 121.0 },
            { name: 'W-185', exemption_level: 10**7, t_medium: 75.1 },
            { name: 'W-187', exemption_level: 10**6, t_medium: hours(23.9) },
            { name: 'W-188', exemption_level: 10**5, t_medium: 69.4 },
        ]
      },
      { short: 'Re', long: 'Rhenium',      mass: 186.207,   category:  2,
        radionuclides: [
            { name: 'Re-177', exemption_level: 10**6, t_medium: hours(0.233) },
            { name: 'Re-178', exemption_level: 10**6, t_medium: hours(0.220) },
            { name: 'Re-181', exemption_level: 10**6, t_medium: hours(20.0) },
            { name: 'Re-182', exemption_level: 10**6, t_medium: 2.67 },
            { name: 'Re-182m', exemption_level: 10**6, t_medium: hours(12.7) },
            ...
            { name: 'Re-186m', exemption_level: 10**7, t_medium: years(2.0*(10**5)) },
            { name: 'Re-187', exemption_level: 10**9, t_medium: years(5.0*(10**10)) },
            { name: 'Re-188', exemption_level: 10**5, t_medium: hours(17.0) },
            { name: 'Re-188m', exemption_level: 10**7, t_medium: hours(0.3) },
            { name: 'Re-189', exemption_level: 10**6, t_medium: 1.01 },
        ]
      },
      { short: 'Os', long: 'Osmium',       mass: 190.23,    category:  2,
        radionuclides: [
            { name: 'Os-180', exemption_level: 10**7, t_medium: hours(0.366) },
            { name: 'Os-181', exemption_level: 10**6, t_medium: hours(1.75) },
            { name: 'Os-182', exemption_level: 10**6, t_medium: hours(22.0) },
            { name: 'Os-185', exemption_level: 10**6, t_medium: 94.0 },
            { name: 'Os-189m', exemption_level: 10**7, t_medium: hours(6.0) },
            { name: 'Os-191', exemption_level: 10**7, t_medium: 15.4 },
            { name: 'Os-191m', exemption_level: 10**7, t_medium: hours(13.0) },
            { name: 'Os-193', exemption_level: 10**6, t_medium: 1.25 },
            { name: 'Os-194', exemption_level: 10**5, t_medium: years(6.0) },
        ]
      },
      { short: 'Ir', long: 'Iridium',      mass: 192.22,    category:  2,
        radionuclides: [
            { name: 'Ir-182', exemption_level: 10**5, t_medium: hours(0.250) },
            { name: 'Ir-184', exemption_level: 10**6, t_medium: hours(3.2) },
            { name: 'Ir-185', exemption_level: 10**6, t_medium: hours(14.0) },
            { name: 'Ir-186', exemption_level: 10**6, t_medium: hours(15.8) },
            { name: 'Ir-186m', exemption_level: 10**6, t_medium: hours(1.75) },
            { name: 'Ir-187', exemption_level: 10**6, t_medium: hours(10.5) },
            ...
            { name: 'Ir-190m', exemption_level: 10**6, t_medium: hours(3.10) },
            { name: 'Ir-190mp', exemption_level: 10**7, t_medium: hours(1.20) },
            { name: 'Ir-192', exemption_level: 10**4, t_medium: 74.0 },
            { name: 'Ir-192m', exemption_level: 10**7, t_medium: years(2.41*(10**2)) },
            { name: 'Ir-193m', exemption_level: 10**7, t_medium: 11.9 },
            { name: 'Ir-194', exemption_level: 10**5, t_medium: hours(19.1) },
            { name: 'Ir-194m', exemption_level: 10**6, t_medium: 171.0 },
            { name: 'Ir-195', exemption_level: 10**6, t_medium: hours(2.50) },
            { name: 'Ir-195m', exemption_level: 10**6, t_medium: hours(3.80) },
        ]
      },
      { short: 'Pt', long: 'Platinum',     mass: 195.08,    category:  2,
        radionuclides: [
            { name: 'Pt-186', exemption_level: 10**6, t_medium: hours(2.0) },
            { name: 'Pt-188', exemption_level: 10**6, t_medium: 10.2 },
            { name: 'Pt-189', exemption_level: 10**6, t_medium: hours(10.9) },
            { name: 'Pt-191', exemption_level: 10**6, t_medium: 2.80 },
            { name: 'Pt-193', exemption_level: 10**7, t_medium: years(50.0) },
            { name: 'Pt-193m', exemption_level: 10**7, t_medium: 4.33 },
            { name: 'Pt-195m', exemption_level: 10**6, t_medium: 4.02 },
            { name: 'Pt-197', exemption_level: 10**6, t_medium: hours(18.3) },
            { name: 'Pt-197m', exemption_level: 10**6, t_medium: hours(1.57) },
            { name: 'Pt-199', exemption_level: 10**6, t_medium: hours(0.513) },
            { name: 'Pt-200', exemption_level: 10**6, t_medium: hours(12.5) },
        ]
      },
      { short: 'Au', long: 'Gold',         mass: 196.9665,  category:  2,
        radionuclides: [
            { name: 'Au-193', exemption_level: 10**7, t_medium: hours(17.6) },
            ...
            { name: 'Au-200', exemption_level: 10**5, t_medium: hours(0.807) },
            { name: 'Au-200m', exemption_level: 10**6, t_medium: hours(18.7) },
            { name: 'Au-201', exemption_level: 10**6, t_medium: hours(0.440) },
        ]
      },
      { short: 'Hg', long: 'Mercury',      mass: 200.59,    category:  2,
        radionuclides: [
            { name: 'Hg-193', exemption_level: 10**6, t_medium: hours(3.50) },
            { name: 'Hg-193m', exemption_level: 10**6, t_medium: hours(11.1) },
            { name: 'Hg-194', exemption_level: 10**6, t_medium: years(2.60*(10**2)) },
            { name: 'Hg-195', exemption_level: 10**6, t_medium: hours(9.90) },
            { name: 'Hg-195m', exemption_level: 10**6, t_medium: 1.73 },
            { name: 'Hg-197', exemption_level: 10**7, t_medium: 2.67 },
            { name: 'Hg-197m', exemption_level: 10**6, t_medium: hours(23.8) },
            { name: 'Hg-199m', exemption_level: 10**6, t_medium: hours(0.710) },
            { name: 'Hg-203', exemption_level: 10**2, t_medium: 46.6 },
        ]
      },   # 80
      { short: 'Tl', long: 'Thallium',     mass: 204.3833,  category:  3,
        radionuclides: [
            { name: 'Tl-194', exemption_level: 10**6, t_medium: hours(0.550) },
            { name: 'Tl-194m', exemption_level: 10**6, t_medium: hours(0.546) },
            { name: 'Tl-195', exemption_level: 10**6, t_medium: hours(1.16) },
            { name: 'Tl-197', exemption_level: 10**6, t_medium: hours(2.84) },
            { name: 'Tl-198', exemption_level: 10**6, t_medium: hours(5.30) },
            { name: 'Tl-198m', exemption_level: 10**6, t_medium: hours(1.87) },
            { name: 'Tl-199', exemption_level: 10**6, t_medium: hours(7.42) },
            ...
            { name: 'Tl-204', exemption_level: 10**4, t_medium: years(3.78) },
        ]
      },
      { short: 'Pb', long: 'Lead',         mass: 204.3833,  category:  3,
        radionuclides: [
            { name: 'Pb-195m', exemption_level: 10**6, t_medium: hours(0.263) },
            { name: 'Pb-198', exemption_level: 10**6, t_medium: hours(2.40) },
            { name: 'Pb-199', exemption_level: 10**6, t_medium: hours(1.50) },
            { name: 'Pb-200', exemption_level: 10**6, t_medium: hours(21.5) },
            { name: 'Pb-201', exemption_level: 10**6, t_medium: hours(9.40) },
            { name: 'Pb-202', exemption_level: 10**6, t_medium: years(3.0*(10**5)) },
            { name: 'Pb-202m', exemption_level: 10**6, t_medium: hours(3.62) },
            { name: 'Pb-203', exemption_level: 10**6, t_medium: 2.17 },
            { name: 'Pb-205', exemption_level: 10**7, t_medium: years(1.43*(10**7)) },
            { name: 'Pb-209', exemption_level: 10**6, t_medium: hours(3.25) },
            { name: 'Pb-210', exemption_level: 10**4, t_medium: years(22.3) },
            { name: 'Pb-211', exemption_level: 10**6, t_medium: hours(0.601) },
            { name: 'Pb-212', exemption_level: 10**5, t_medium: hours(10.6) },
            { name: 'Pb-214', exemption_level: 10**6, t_medium: hours(0.447) },
        ]
      },
      { short: 'Bi', long: 'Bismuth',      mass: 208.98037, category:  3,
        radionuclides: [
            { name: 'Bi-200', exemption_level: 10**6, t_medium: hours(0.606) },
            { name: 'Bi-201', exemption_level: 10**6, t_medium: hours(1.80) },
            { name: 'Bi-202', exemption_level: 10**6, t_medium: hours(1.67) },
            { name: 'Bi-203', exemption_level: 10**6, t_medium: hours(11.8) },
            { name: 'Bi-205', exemption_level: 10**6, t_medium: 15.3 },
            { name: 'Bi-206', exemption_level: 10**5, t_medium: 6.24 },
            { name: 'Bi-207', exemption_level: 10**6, t_medium: years(38.0) },
            { name: 'Bi-210', exemption_level: 10**6, t_medium: 5.01 },
            { name: 'Bi-210m', exemption_level: 10**5, t_medium: years(3.0*(10**6)) },
            { name: 'Bi-212', exemption_level: 10**5, t_medium: hours(1.01) },
            { name: 'Bi-213', exemption_level: 10**6, t_medium: hours(0.761) },
            { name: 'Bi-214', exemption_level: 10**5, t_medium: hours(0.332) },
        ]
      },
      { short: 'Po', long: 'Polonium',     mass: 208.9824,  category:  4,
        radionuclides: [
            { name: 'Po-203', exemption_level: 10**6, t_medium: hours(0.612) },
            { name: 'Po-205', exemption_level: 10**6, t_medium: hours(1.80) },
            { name: 'Po-206', exemption_level: 10**6, t_medium: nil },
            { name: 'Po-207', exemption_level: 10**6, t_medium: hours(5.83) },
      ...
      { short: 'At', long: 'Astatine',     mass: 209.9871,  category:  6,
        radionuclides: [
            { name: 'At-207', exemption_level: 10**6, t_medium: hours(1.80) },
            { name: 'At-211', exemption_level: 10**7, t_medium: hours(7.21) },
        ]
      },
      ...
      { short: 'Fr', long: 'Francium',     mass: 223.0197,  category:  0,
        radionuclides: [
            { name: 'Fr-222', exemption_level: 10**5, t_medium: hours(0.240) },
            { name: 'Fr-223', exemption_level: 10**6, t_medium: hours(0.363) },
        ]
      },
      { short: 'Ra', long: 'Radium',       mass: 226.0254,  category:  1,
        radionuclides: [
            ...
            { name: 'Ra-226', exemption_level: 10**4, t_medium: years(1.60*(10**3)) },
            { name: 'Ra-227', exemption_level: 10**6, t_medium: hours(0.703) },
            { name: 'Ra-228', exemption_level: 10**5, t_medium: years(5.75) },
        ]
      },

      { short: 'Ac', long: 'Actinium',     mass: 227.0278,  category:  9,
        radionuclides: [
            { name: 'Ac-224', exemption_level: 10**6, t_medium: hours(2.90) },
            { name: 'Ac-225', exemption_level: 10**4, t_medium: 10.0 },
            { name: 'Ac-226', exemption_level: 10**5, t_medium: 1.21 },
            { name: 'Ac-227', exemption_level: 10**3, t_medium: years(21.8) },
            { name: 'Ac-228', exemption_level: 10**6, t_medium: hours(6.13) },
        ]
      },
      { short: 'Th', long: 'Thorium',      mass: 232.0381,  category:  9,
        radionuclides: [
            { name: 'Th-226', exemption_level: 10**7, t_medium: hours(0.515) },
            { name: 'Th-227', exemption_level: 10**4, t_medium: 18.7 },
            { name: 'Th-228', exemption_level: 10**4, t_medium: years(1.91) },
            { name: 'Th-229', exemption_level: 10**3, t_medium: years(7.34*(10**3)) },
            { name: 'Th-230', exemption_level: 10**4, t_medium: years(7.70*(10**4)) },
            { name: 'Th-231', exemption_level: 10**7, t_medium: 1.06 },
            { name: 'Th-232', exemption_level: 10**4, t_medium: years(1.40*(10**10)) },
            { name: 'Th-234', exemption_level: 10**5, t_medium: 24.1 },
        ]
      },   # 90
      { short: 'Pa', long: 'Protactinium', mass: 231.03588, category:  9,
        radionuclides: [
            { name: 'Pa-227', exemption_level: 10**6, t_medium: hours(0.638) },
            { name: 'Pa-228', exemption_level: 10**6, t_medium: hours(22.0) },
            { name: 'Pa-230', exemption_level: 10**6, t_medium: 17.4 },
            { name: 'Pa-231', exemption_level: 10**3, t_medium: years(3.27*(10**4)) },
            { name: 'Pa-232', exemption_level: 10**6, t_medium: 1.31 },
            { name: 'Pa-233', exemption_level: 10**7, t_medium: 27.0 },
            { name: 'Pa-234', exemption_level: 10**6, t_medium: hours(6.70) },
        ]
      },
      { short: 'U',  long: 'Uranium',      mass: 238.0289,  category:  9,
        radionuclides: [
            ...
            { name: 'U-232', exemption_level: 10**3, t_medium: years(72.0) },
            { name: 'U-233', exemption_level: 10**4, t_medium: years(1.58*(10**5)) },
            { name: 'U-234', exemption_level: 10**4, t_medium: years(2.44*(10**5)) },
            { name: 'U-235', exemption_level: 10**4, t_medium: years(7.04*(10**8)) },
            { name: 'U-236', exemption_level: 10**4, t_medium: years(2.34*(10**7)) },
            { name: 'U-237', exemption_level: 10**6, t_medium: 6.75 },
            { name: 'U-238', exemption_level: 10**4, t_medium: years(4.47*(10**9)) },
            { name: 'U-239', exemption_level: 10**6, t_medium: hours(0.392) },
            { name: 'U-240', exemption_level: 10**7, t_medium: hours(14.1) },
            { name: 'U-240', exemption_level: 10**6, t_medium: hours(14.1) },
        ]
      },
      { short: 'Np', long: 'Neptunium',    mass: 237.0482,  category:  9,
        radionuclides: [
            { name: 'Np-232', exemption_level: 10**6, t_medium: hours(0.245) },
            { name: 'Np-233', exemption_level: 10**7, t_medium: hours(0.603) },
            { name: 'Np-234', exemption_level: 10**6, t_medium: 4.40 },
            { name: 'Np-235', exemption_level: 10**7, t_medium: years(1.08) },
            { name: 'Np-236', exemption_level: 10**5, t_medium: years(1.15*(10**5)) },
            { name: 'Np-236m', exemption_level: 10**7, t_medium: hours(22.5) },
            { name: 'Np-237', exemption_level: 10**3, t_medium: years(2.14*(10**6)) },
            { name: 'Np-238', exemption_level: 10**6, t_medium: 2.12 },
            { name: 'Np-239', exemption_level: 10**7, t_medium: 2.36 },
            { name: 'Np-240', exemption_level: 10**6, t_medium: hours(1.08) },
        ]
      },
      { short: 'Pu', long: 'Plutonium',    mass: 244.0642,  category:  9,
        radionuclides: [
            { name: 'Pu-234', exemption_level: 10**7, t_medium: hours(8.80) },
            { name: 'Pu-235', exemption_level: 10**7, t_medium: hours(0.422) },
            { name: 'Pu-236', exemption_level: 10**4, t_medium: years(2.85) },
            { name: 'Pu-237', exemption_level: 10**7, t_medium: 45.3 },
            { name: 'Pu-238', exemption_level: 10**4, t_medium: years(87.7) },
            { name: 'Pu-239', exemption_level: 10**4, t_medium: years(2.41*(10**4)) },
            { name: 'Pu-240', exemption_level: 10**3, t_medium: years(6.54*(10**3)) },
            { name: 'Pu-241', exemption_level: 10**5, t_medium: years(14.4) },
            { name: 'Pu-242', exemption_level: 10**4, t_medium: years(3.76*(10**5)) },
            { name: 'Pu-243', exemption_level: 10**7, t_medium: hours(4.95) },
            { name: 'Pu-244', exemption_level: 10**4, t_medium: years(8.26*(10**7)) },
            { name: 'Pu-245', exemption_level: 10**6, t_medium: hours(10.5) },
            { name: 'Pu-246', exemption_level: 10**6, t_medium: 10.9 },
        ]
      },
      { short: 'Am', long: 'Americium',    mass: 243.0614,  category:  9,
        radionuclides: [
            { name: 'Am-237', exemption_level: 10**6, t_medium: hours(1.22) },
            { name: 'Am-238', exemption_level: 10**6, t_medium: hours(1.63) },
            { name: 'Am-239', exemption_level: 10**6, t_medium: hours(11.9) },
            { name: 'Am-240', exemption_level: 10**6, t_medium: 2.12 },
            { name: 'Am-241', exemption_level: 10**4, t_medium: years(4.32*(10**2)) },
            { name: 'Am-242', exemption_level: 10**6, t_medium: hours(16.0) },
            { name: 'Am-242m', exemption_level: 10**4, t_medium: years(1.52*(10**2)) },
            { name: 'Am-243', exemption_level: 10**3, t_medium: years(7.38*(10**3)) },
            { name: 'Am-244', exemption_level: 10**6, t_medium: hours(10.1) },
            { name: 'Am-244m', exemption_level: 10**7, t_medium: hours(0.433) },
            { name: 'Am-245', exemption_level: 10**6, t_medium: hours(2.05) },
            { name: 'Am-246', exemption_level: 10**5, t_medium: hours(0.650) },
            { name: 'Am-246m', exemption_level: 10**6, t_medium: hours(0.417) },
        ]
      },
      { short: 'Cm', long: 'Curium',       mass: 247.0703,  category:  9,
        radionuclides: [
            { name: 'Cm-238', exemption_level: 10**7, t_medium: hours(2.40) },
            ...
            { name: 'Cm-243', exemption_level: 10**4, t_medium: years(28.5) },
            { name: 'Cm-244', exemption_level: 10**4, t_medium: years(18.1) },
            { name: 'Cm-245', exemption_level: 10**3, t_medium: years(8.50*(10**3)) },
            { name: 'Cm-246', exemption_level: 10**3, t_medium: years(4.73*(10**3)) },
            { name: 'Cm-247', exemption_level: 10**4, t_medium: years(1.56*(10**7)) },
            { name: 'Cm-248', exemption_level: 10**3, t_medium: years(3.39*(10**5)) },
            { name: 'Cm-249', exemption_level: 10**6, t_medium: hours(1.07) },
            { name: 'Cm-250', exemption_level: 10**3, t_medium: years(6.90*(10**3)) },
        ]
      },
      { short: 'Bk', long: 'Berkelium',    mass: 247.0703,  category:  9,
        radionuclides: [
            ...
            { name: 'Bk-247', exemption_level: 10**4, t_medium: years(1.38*(10**3)) },
            { name: 'Bk-249', exemption_level: 10**6, t_medium: 320.0 },
            { name: 'Bk-250', exemption_level: 10**6, t_medium: hours(3.22) },
        ]
      },
      { short: 'Cf', long: 'Californium',  mass: 251.0796,  category:  9,
        radionuclides: [
            { name: 'Cf-244', exemption_level: 10**7, t_medium: hours(0.323) },
            { name: 'Cf-246', exemption_level: 10**6, t_medium: 1.49 },
            { name: 'Cf-248', exemption_level: 10**4, t_medium: 334.0 },
            { name: 'Cf-249', exemption_level: 10**3, t_medium: years(3.50*(10**2)) },
            { name: 'Cf-250', exemption_level: 10**4, t_medium: years(13.1) },
            { name: 'Cf-251', exemption_level: 10**3, t_medium: years(8.98*(10**2)) },
            { name: 'Cf-252', exemption_level: 10**4, t_medium: years(2.64) },
      ...
      { short: 'Es', long: 'Einsteinium',  mass: 254,       category:  9,
        radionuclides: [
            { name: 'Es-250', exemption_level: 10**6, t_medium: hours(2.10) },
      ...
      { short: 'Fm', long: 'Fermium',      mass: 257.0951,  category:  9,
        radionuclides: [
            { name: 'Fm-252', exemption_level: 10**6, t_medium: hours(22.7) },
            { name: 'Fm-253', exemption_level: 10**6, t_medium: 3.0 },
            { name: 'Fm-254', exemption_level: 10**7, t_medium: hours(3.24) },
            { name: 'Fm-255', exemption_level: 10**6, t_medium: hours(20.1) },
            { name: 'Fm-257', exemption_level: 10**5, t_medium: 101.0 },
        ]
      },   # 100
      { short: 'Md', long: 'Mendelevium',  mass: 258.1,     category:  9,
        radionuclides: [
            { name: 'Md-257', exemption_level: 10**7, t_medium: hours(5.20) },
